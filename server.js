...
transporter.verify((error, success) => {
  if (error) {
    console.log('❌ EMAIL ERROR - Connection failed:', error.message);
  } else {
    console.log('✅ EMAIL SUCCESS - Ready to send!');
  }
});

console.log('📧 Email configured for: edcleff0@gmail.com');
